...
import { Heart, MessageCircle, MoreHorizontal, Trash2, Edit3, X } from "lucide-react";
    ...
    <>
      <article className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-4">
        ...
        <div className="flex items-center justify-between p-4">
          <Link href={`/${userAuthId}`} className="flex items-center gap-3 group">
            <Image
        ...
        {selectedAnime && (
          <div className="mx-4 mb-3">
            <a 
              ...
              className="block p-3 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl border border-red-100 hover:from-red-100 hover:to-pink-100 transition-colors group"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  {/* <p className="text-xs text-gray-500 mt-1">Click to view on MyAnimeList →</p> */}
                </div>
              </div>
            </a>
          </div>
        ...
        {userBio && (
          <div className="px-4 pb-2 md:hidden">
            <p className="text-sm text-gray-600 italic">"{userBio}"</p>
          </div>
        )}
            ...
            {comments && comments.length > 0 && (
              <div className="p-4 space-y-3 max-h-64 overflow-y-auto">
                {comments.map((comment) => {
                  ...
                  const currentUser = userDataJSON ? JSON.parse(userDataJSON) : null;
                  const currentUserId = currentUser?.user?.uid;
                  const canDeleteComment = comment.userId === currentUserId || userAuthId === currentUserId;
